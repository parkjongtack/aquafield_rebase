    ...
    <div class="iscContent">
    	<div class="inner">
    		<article class="txtContent">
    			<div id="privacy">
					<h1>아쿠아필드는 회원님들의 개인정보를 소중히 다루고있습니다. </h1>
						...
						<h3>①아쿠아필드는 법령에 따른 개인정보 보유•이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.</h3>
						<h3>②각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</h3>
						<h4>1. &lt;제화 또는 서비스 제공&gt;</h4>
						...
						<h3>①아쿠아필드는 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</h3>
						<h3>②아쿠아필드는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.</h3>
						<h4>1. &lt;(주)케이에스넷&gt;</h4>
						<p>- 개인정보를 제공받는 자 : (주)케이에스넷</p>
						<p>- 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호, 이름, 신용카드정보, 은행계좌정보, 서비스 이용 기록, 결제기록</p>
						<p class="last">- 제공받는 자의 보유이용기간: 5년</p>

						<h2>4. 정보주체의 권리,의무 및 그 행사방법 이용자는 개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다.</h2>
						<h3>① 정보주체는 아쿠아필드에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</h3>
						<h4>1. 개인정보 열람요구</h4>
						<h4>2. 오류 등이 있을 경우 정정 요구</h4>
						<h4>3. 삭제요구</h4>
						<h4>4. 처리정지 요구</h4>
						<h3>② 제1항에 따른 권리 행사는아쿠아필드에 대해 개인정보 보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 <기관/회사명>(‘사이트URL’이하 ‘사이트명) 은(는) 이에 대해 지체 없이 조치하겠습니다.</h3>
						<h3>③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 <기관/회사명>(‘사이트URL’이하 ‘사이트명) 은(는) 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.</h3>
						<h3 class="last">④ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.</h3>

						<h2>5. 처리하는 개인정보의 항목 작성</h2>
						<h3>①아쿠아필드는 다음의 개인정보 항목을 처리하고 있습니다.</h3>
						<h4>1. &lt;홈페이지 회원가입 및 관리&gt;</h4>
						<p>- 필수항목 :이메일, 휴대전화번호, 비밀번호, 접속 아이디, 이름</p>
						<p class="last">- 선택항목 :생년월일, 자택주소, 자택전화번호, 직장명, 직장주소, 직장전화번호, 직업, 기념일 등</p>

						<h2>6. 인정보의 파기</h2>
						<h3>아쿠아필드는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다</h3>
						...
						<h3>아쿠아필드는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</h3>
						<h4>1. 정기적인 자체 감사 실시</h4>
						<p>개인정보 취급 관련 안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.</p>
						<h4>2. 개인정보 취급 직원의 최소화 및 교육</h4>
						<p>개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을 시행하고 있습니다.</p>
						<h4>3. 내부관리계획의 수립 및 시행</h4>
						...
						<p>연락처 : 031-8072-8800</p>
						<p>이메일 : aquafield@shinsegae.com</p>
						<h3 class="last">② 정보주체께서는 아쿠아필드의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 아쿠아필드는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</h3>

						<h2>9. 개인정보 처리방침 변경</h2>
						<h3 class="last">① 이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.</h3>
				</div>
    		</article>
    	</div>
    </div>
