		...
		<div class="contents_bx_inner">
			<div id="path" class="fixed">
				<div class="pathInner">
					<h2>운영관리자</h2>
					<div class="btns_area">
						<a href="/admin/manager/operations_manager_write.jsp" class="btn_pack btn_mo d_gray"><img src="/common/admin/images/common/ico_add.png">생성</a>
					</div>
				</div>
			</div>
			<div class="tb_type2">
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>2015.07.24</td>
							<td>2015.07.24</td>
							<td><a href="/admin/manager/operations_manager_view.jsp" class="link">보기</a></td>
						</tr>
						<tr>
							<td>홍길동</td>
