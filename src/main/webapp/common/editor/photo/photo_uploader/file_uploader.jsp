...
<%
	...
	<%
		...
		if (!upfile.equals("")) {
			...
			editorhtml = "<img src=\""+saveFolder + moveTargetName+"\">";
		...
		String contentUrl = multi.getParameter("contentUrl");
		
		if(contentUrl != null && !contentUrl.equals("")){
			editorhtml = "<a href=\""+contentUrl+"\" target=\"_blank\"><img src=\""+saveFolder + moveTargetName+"\"></a>";
		}
...
<script type="text/javascript">
	opener.parent.pasteHTML('<%=editorhtml%>'); 
	window.close();
</script>