...
<body topmargin=0 leftmargin=0>
	<a onclick="self.close();" style="cursor:pointer;">
		<img src="/common/front/images/POINT01/main/hanam_20190130.jpg" alt="AQUAFIELD">
	</a>
	<div style="border-top:1px solid #ddd; height:36px;padding-top:8px;">
		<span><input type="checkbox" name="hanam20190130" id="hanam20190130" onclick="closePop();"/><label for="hanam20190130">오늘하루 그만 보기</label></span>
