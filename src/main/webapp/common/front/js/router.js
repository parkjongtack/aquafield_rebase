...
var FacilityFn = function(params){
	...
	spa_snack_content_POINT05 = /* "<div class='title'>SPA SNACK MENU</div>" +*/
								/*"<div class='info'><strong>운영시간</strong> : 11:30 - 19:30</div>" +*/
                                "<div class='info'><strong><br/>메인메뉴</strong></div>" +
								"<div class='contents'>" +
									"<ul>" +
									...
									"</ul>" +
								"</div>" +
								"<div class='notice_caption'>※푸드 코너 운영시간 및 메뉴는 상황에 따라 달라질 수 있습니다.</div>";
	...
	var floors_POINT05 = [
		{id : 'floor_rf', zoom:0, name : '야외 워터파크', cate : 0, faci : [{
			...
			unit : [
				...
				{l:59.5, b:56,name : '썬베드', text: '실내 및 야외에 설치되어 있어 편안하게 물놀이를 즐기실 수 있습니다.' + outside_content_POINT05, cate:0, dubble_ico:1},
				...
				{l:64.5, b:56,name : '체온<br/>유지실', text: '야외에서 오랫동안 물놀이를 즐기신 후,<br/>경치를 즐기며 떨어진 체온을 따뜻하게 올려주는 공간입니다.', cate:0}
			]
		}]},
		{id : 'floor_4f', zoom:1, name : '3층 전체', cate : 1, faci : [{
			...
			unit : [
				...
				{l:20.9, b:55.5,name : '유아<br/>휴게실', text: '휴식이 필요한 아이에게 편안하고 쾌적하게 휴식할 수 있는 공간입니다.', cate:2},
			...
			unit : [
				...
				{l:53.5, b:57.5,name : '스낵바', text: '찜질스파에서 흘린 땀을 식혀줄 추억을 담은 전통적인 먹거리와 간단한 스낵류를 즐길 수 있습니다.' + spa_snack_content_POINT05, cate:3}
			...
			unit : [
				...
				{l:37.8, b:54,name : '노천탕<br/>(여)', text: '야외 탕 속에서 피로를 풀고, 여유로운 시간과 색다른 재미를 느낄 수 있습니다.', cate:4},
				...
				{l:1.5, b:66.5,name : '노천탕<br/>(남)', text: '야외 탕 속에서 피로를 풀고, 여유로운 시간과 색다른 재미를 느낄 수 있습니다.', cate:4},
				{l:1.5, b:60,name : '사우나<br/>(남)', text: '다양한 탕 속에서 색다른 재미를 느끼며, 피로를 풀고 여유로운 시간을 보내실 수 있습니다.', cate:4},
