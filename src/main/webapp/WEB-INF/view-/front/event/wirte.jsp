					...
					<div class="box-content">
						<div class="content on">
						    ...
						    <section id="news_write">
						        ...
						        <input type="hidden" name="POINT_CODE" id="POINT_CODE" value="${POINT_URL }" />
						                            ...
						                            <tr class="require">
						                                ...
						                                <td>
						                                    <div class="chk_motion lst_check radio">
						                                        ...
						                                        <span>
						                                            <label>
						                                                미디어<input type="radio" name="KIND" id="writeType" value="3">
						                                            </label>
						                                        </span>
						                                    </div>
						                                </td>
						        ...
						        function noticeCancel(){
						            //location.href='#/event/eventIndex.af?cate=all'+new Date().getTime();
						            //location.href='#/event/eventIndex.af?cate=all';
						            document.referrer ? history.back() : location.href="#/event/eventIndex.af?cate=0"+"&pointCode="+$("#POINT_CODE").val();
						        }
