                        ...
                        <div class="content on">
                            ...
                            <section>
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr class="require">
                                                            ...
                                                            <td>
                                                                <div class="chk_motion lst_check radio">
                                                                    <span>
                                                                        <label>
                                                                            공지사항<input type="radio" name="KIND" id="writeType" value="1"<c:if test="${result.KIND eq '1'}"> checked</c:if>>
                                                                        </label>
                                                                    </span>
                                                                    <span>
                                                                        <label>
                                                                            이벤트<input type="radio" name="KIND" id="writeType" value="2"<c:if test="${result.KIND eq '2'}"> checked</c:if>>
                                                                        </label>
                                                                    </span>
                                                                    <span>
                                                                        <label>
                                                                            미디어<input type="radio" name="KIND" id="writeType" value="3"<c:if test="${result.KIND eq '3'}"> checked</c:if>>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr class="require">
                                                            ...
                                                            <td>
                                                                <div class="placeh">
                                                                    <input type="text" class="ipt w160 datepicker" name="VIEW_START_DATE" id="VIEW_START_DATE" value="${result.VIEW_START_DATE}">
                                                                </div>
                                                                    <span> ~ </span>
                                                                <div class="placeh">
                                                                    <input type="text" class="ipt w160 datepicker" name="VIEW_END_DATE" id="VIEW_END_DATE" value="${result.VIEW_END_DATE}">
                                                        ...
                                                        <tr class="require">
                                                            ...
                                                            <td>
                                                                <div class="placeh">
                                                                    <input type="text" class="ipt w160 datepicker" name="START_DATE" id="START_DATE" value="${result.START_DATE}">
                                                                </div>
                                                                    <span> ~ </span>
                                                                <div class="placeh">
                                                                    <input type="text" class="ipt w160 datepicker" name="END_DATE" id="END_DATE" value="${result.END_DATE}">
                                                        ...
                                                        <tr class="require">
                                                            <th>제   목<span>*</span></th>
                                                            <td>
                                                                <input type="text" class="ipt mw430" name="TITLE" onblur="" maxlength="200" value="${result.TITLE}">
                                                            </td>
                                                        </tr>
                                                        <tr class="require">
                                                            ...
                                                            <td>
                                                                <div class="imginputs" data-text="파일첨부">
                                                                    ...
                                                                    <div class="fakeimg">
                                                                        <div id="imgArea_1" class="imgArea"><c:if test="${not empty result.FILE_LIST_FULL}"><img src="${result.FILE_LIST_FULL}" class="img"></c:if></div>
                                                        ...
                                                        <tr class="require">
                                                            ...
                                                            <td>
                                                                <div class="chk_motion lst_check radio" style="margin-bottom: 10px;">
                                                                    <span>
                                                                        <label<c:if test="${result.WRITE_TYPE eq '1'}"> class="on"</c:if>>
                                                                            이미지<input type="radio" name="WRITE_TYPE" id="WRITE_TYPE" value="1"<c:if test="${result.WRITE_TYPE eq '1'}"> checked</c:if>>
                                                                        </label>
                                                                    </span>
                                                                    <span>
                                                                        <label<c:if test="${result.WRITE_TYPE eq '2'}"> class="on"</c:if>>
                                                                            에디터<input type="radio" name="WRITE_TYPE" id="WRITE_TYPE" value="2"<c:if test="${result.WRITE_TYPE eq '2'}"> checked</c:if>>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                                <div class="imgUpload">
                                                                    <div class="imginputs pics" data-text="파일첨부">
                                                                        ...
                                                                        <div class="fakeimg">
                                                                            <div id="imgArea_2" class="imgArea"><c:if test="${not empty result.FILE_CONTENT_FULL}"><img src="${result.FILE_CONTENT_FULL}" class="img"></c:if></div>
                                                                            <button type="button">파일첨부</button>
                                                                        </div>
                                                                    </div>  
                                                                </div>
                                                                <div class="bx_editer">
                                                                    <textarea name="CONTENTS" id="CONTENTS" rows="20" cols="100">${result.CONTENTS}</textarea>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                ...
                                <script type="text/javascript">
                                    var defaultFileList = "${result.FILE_LIST_FULL}";
                                    var defaultFileContent = "${result.FILE_CONTENT_FULL}";
                                    ...
                                    function readURL(input, section){
                                        ...
                                        if(path == ""){
                                            ...
                                            if(section == 1){
                                                if(defaultFileList != ""){
                                                    var img = '<img src="'+defaultFileList+'" class="img"/>'
                                                    $('#imgArea_' + section).html(img);
                                                }   
                                            }
                                            else{
                                                if(defaultFileContent != ""){
                                                    var img = '<img src="'+defaultFileContent+'" class="img"/>'
                                                    $('#imgArea_' + section).html(img);
                                                }
                                            }                    
                                           return;
                                ...
                                function noticeCancel(){
                                    ...
                                    document.referrer ? history.go(-2) : location.href="#/event/eventIndex.af?cate=all&pointCode="+$("#POINT_CODE").val();
                                }
