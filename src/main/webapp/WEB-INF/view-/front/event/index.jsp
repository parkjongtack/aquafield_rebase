					...
					<div class="box-content">
						<div class="content on">
							...
							<section>
								...
								<div class="news-list container iscContent">
									<div class="inner">
										<ul class="grid">
											<!-- Ajax Load -->
										</ul>
							...
							<script type="text/javascript">
								...
								function point05(num) {
									window.location.reload();
									if(num == 1) {
										location.href = "/ansung/index.af#/event/eventIndex.af?cate=1";
									} else {
										location.href = "/ansung/index.af#/event/eventIndex.af?cate=2";																			
									}
								}								
