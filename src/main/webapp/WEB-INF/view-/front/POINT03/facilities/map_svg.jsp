...
<div class="list_floors detail">
	<ul>
		<li class="f1"><div class="tit"><img src="/common/front/images/facilities/RF_tit.png" alt="RF"></div><ul class="nav_sect"></ul><div class="in"><div class="bx_svg"><%@ include file="RF.svg" %><div class="bx_pin"></div></div></div></li>
		<li class="f2"><div class="tit"><img src="/common/front/images/facilities/4F_tit.png" alt="4F"></div><ul class="nav_sect"></ul><div class="in"><div class="bx_svg"><%@ include file="4F.svg" %><div class="bx_pin"></div></div></div></li>
	</ul>
</div>
<nav class="nav_floor">
	<ul>
