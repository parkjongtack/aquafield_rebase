		...
		<li class="f2">
			...
			<div class="in">
				<div class="bx_svg">
					...
					<div class="faci">
						<div id="floor_4f_1" style="width:58%;height:80%;top: 0;left: 7.6%;"></div>
						<div id="floor_4f_2" style="width:41%;height:68%;top: 24.5%;left: 0;"></div>
						<div id="floor_4f_3" style="width:15%;height:28%;top: 0;left: 0;";></div>
						<!-- <div id="floor_4f_4" style="width:13.5%;height: 27%;top: 72.3%;left: 21.6%;"></div> -->
					</div>
					<img src="/common/front/images/${POINT_CODE}/facilities/img_4f.png" alt="4F_MAP"/>
				</div>
			</div>
		</li>
		<!-- <li class="f3"><div class="tit"><img src="/common/front/images/${POINT_CODE}/facilities/3F_tit.png"></div><ul class="nav_sect"></ul><div class="in"><div class="bx_svg"><img src="/common/front/images/${POINT_CODE}/facilities/img_3f.png" alt=""><div class="bx_pin"></div></div></div></li> -->
	</ul>
</div>
<nav class="nav_floor">
	<ul>
