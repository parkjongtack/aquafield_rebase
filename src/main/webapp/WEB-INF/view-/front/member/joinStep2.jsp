						...
						<form action="/member/joinStep3.af" id="step02" name="step02" method="post">
				            ...
				            <div class="form_type3 type3">
				                <ul>
				                    <li class="require">
									    <div class="placeh">
										   <input type="text" class="ipt bd_hide injectAble" name="userName" id="name" value="${parameter.objName}" placeholder="이름"   onblur="chkAccount.name(this)" readOnly>
										   <label for="name" style=""></label>
									    </div>
				                    </li>
					                <li class="require">
										<div class="placeh">
											 <input type="text" class="ipt bd_hide injectAble" name="phonenum" id="phonenum" value="${parameter.objMNum}" placeholder="휴대폰번호"   onblur="chkAccount.phone(this)" readOnly>
											 <label for="phonenum" style=""></label>
									 	</div>
					                </li>
					                <li class="require">
										<div class="placeh">
											 <input type="text" class="ipt bd_hide injectAble" name="userId" id="userid" value="" placeholder="아이디(이메일)"  onchange="emailCheckBlur(this)">
											 <label for="userId" style=""></label>
										</div>
					                </li>
					                <!-- <li class="require">
										<div class="placeh">
											 <input type="password" class="ipt bd_hide injectAble" name="userPw01" id="PWD1"  placeholder="비밀번호"   onblur="chkAccount.pw01(this)">
											 <label for="PWD1" style=""></label>
										</div>
					                </li>
					                <li class="require">
										<div class="placeh">
											 <input type="password" class="ipt bd_hide injectAble" name="userPw02" id="PWD2" placeholder="비밀번호 확인"   onblur="chkAccount.pw02(this,'#PWD1')">
											 <label for="PWD2" style=""></label>
										</div>
					                </li> -->
					                <li class="require">
										<div class="placeh">
											 <input type="password" class="ipt bd_hide injectAble" name="userPw01" id="PWD1"  placeholder="비밀번호"   onchange="pw01(this)">
											 <label for="PWD1" style=""></label>
										</div>
					                </li>
					                <li class="require">
										<div class="placeh">
											 <input type="password" class="ipt bd_hide injectAble" name="userPw02" id="PWD2" placeholder="비밀번호 확인"   onchange="pw02(this,'#PWD1')">
											 <label for="PWD2" style=""></label>
										</div>
					                </li>
