	...
	<div id="login_wrap">
		<!-- <div class="login_top">
	   	...
	   	<div class="inner">
			<h2>내정보 찾기</h2>
				<ul class="tab_menu">
	            <li rel="tab1"><a href="/member/findMemberId.af">아이디 찾기</a></li>
	            <li class="active" rel="tab2"><a href="/member/findMemberPwd.af">비밀번호 찾기</a></li>
	        </ul>
	        ...
	        <div class="login_box">
				...
				<script type="text/javascript">
				   ...
				   function gotoNext(obj){
					   ...
					   $("#searchPw").attr('action', '/member/resultMemberPwd.af');
					   $("#searchPw").submit();
