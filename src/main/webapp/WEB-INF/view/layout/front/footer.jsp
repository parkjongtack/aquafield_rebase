			...
			<div class="inner">
				...
				<div class="info">
					...
					<c:choose>
						...
						<li><a href="../hanam/index.af#/service/index.af?page=terms2">아쿠아필드 이용약관</a></li>
						<li><a href="../hanam/index.af#/service/index.af?page=terms">홈페이지 이용약관</a></li>
						<li class="c_red"><a href="../hanam/index.af#/service/index.af?page=privacy">개인정보 처리방침</a></li>
						<!--<li><a href="#/service/index.af?page=email">이메일 무단수집 거부</a></li>-->
						<li><a href="../hanam/index.af#/service/index.af?page=video">영상정보처리 기기운영/관리방침</a></li>
						<li><a href="../hanam/index.af#/service/index.af?page=communication">통신판매사업자정보</a></li>
						</c:when>
						<c:when test="${POINT_CODE eq 'POINT05'}">
						<li><a href="../anseong/index.af#/service/index.af?page=terms2">아쿠아필드 이용약관</a></li>
						<li><a href="../anseong/index.af#/service/index.af?page=terms">홈페이지 이용약관</a></li>
						<li class="c_red"><a href="../anseong/index.af#/service/index.af?page=privacy">개인정보 처리방침</a></li>
						<!--<li><a href="#/service/index.af?page=email">이메일 무단수집 거부</a></li>-->
						<li><a href="../anseong/index.af#/service/index.af?page=video">영상정보처리 기기운영/관리방침</a></li>
						<li><a href="../anseong/index.af#/service/index.af?page=communication">통신판매사업자정보</a></li>
						</c:when>
						<c:otherwise>
						<li><a href="../goyang/index.af#/service/index.af?page=terms2">아쿠아필드 이용약관</a></li>
						<li><a href="../goyang/index.af#/service/index.af?page=terms">홈페이지 이용약관</a></li>
						<li class="c_red"><a href="../goyang/index.af#/service/index.af?page=privacy">개인정보 처리방침</a></li>
						<!--<li><a href="#/service/index.af?page=email">이메일 무단수집 거부</a></li>-->
						<li><a href="../goyang/index.af#/service/index.af?page=video">영상정보처리 기기운영/관리방침</a></li>
						<li><a href="../goyang/index.af#/service/index.af?page=communication">통신판매사업자정보</a></li>
						</c:otherwise>
					</c:choose>
