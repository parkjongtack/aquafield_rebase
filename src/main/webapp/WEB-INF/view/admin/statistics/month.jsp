		...
		<div class="contents_bx_inner">
			...
			<div class="condi_search inc_date">
	 			<ul class="clearfix">
					...
					<li><a href="/secu_admaf/admin/statistics/day.af">Day</a></li>
					<li class="on"><a href="/secu_admaf/admin/statistics/month.af">Month</a></li>
				</ul>
				<form name="searchForm" id="searchForm" method="post" action="/secu_admaf/admin/statistics/month.af" onsubmit="return false;">
 			...
 			<div class="area_graph">
				<div id="chart_div" style="height:900px;">그래프 영역</div>
	 		</div>
		</div>
 	</div>
</section>
...
var data = google.visualization.arrayToDataTable([
	...
	<c:forEach items="${results}" var="result">
			${comma}['${result.YYYYMM}', ${result.CNT}, ${result.PAGEVIEWCNT}]
	<c:set var="comma" value=","/>
	</c:forEach>
