                        ...
                        <div class="vidoeBox paraShowing" data-dirc='x' data-dist='150' data-ease='Power3.easeInOut' data-dura='1' data-delay='0.5'>
                            <div class="inner">
                                ...
                                <!-- <a href="javascript:void(0);" onclick="comingsoon();"> -->
                                    <%-- <div class="ico_play"><img src="../common/front/images/${POINT_CODE }/about/ico_play.png"/></div>
                                    <img class="videoTumnail" src="../common/front/images/${POINT_CODE }/about/video_box_img.jpg"/> --%>
                                     <%-- 20180403 수정
                                      <img class="videoTumnail" src="/common/front/images/${POINT_CODE }/facilities/img_pop_none.jpg" alt="컨텐츠 준비중입니다">
                                     --%>
                                <!-- 20180403 추가 -->
                                <a href="javascript:void(0);" onclick="window.videoPop = new VideoPopFn({url: '/about/concept/video01.af'});">
                                    <div class="ico_play"><img src="../common/front/images/${POINT_CODE }/about/ico_play.png"/ alt="play"></div>
                                    <img class="videoTumnail" src="../common/front/images/${POINT_CODE }/about/video_box_img_goyang.jpg" alt="boxImage" />
                                </a>
                            </div>
                        </div>
