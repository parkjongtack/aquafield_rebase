...
<div class="list_floors detail">
	<ul>
		<li class="f1"><div class="tit"><img src="/common/front/images/facilities/RF_tit.png"></div><ul class="nav_sect"></ul><div class="in"><div class="bx_svg"><img src="/common/front/images/facilities/img_rf.png" alt=""><div class="bx_pin"></div></div></div></li>
		<li class="f2">
			<div class="tit"><img src="/common/front/images/facilities/4F_tit.png"></div>
			...
			<div class="in">
				<div class="bx_svg">
					...
					<img src="/common/front/images/facilities/img_4f.png" alt=""/>
				</div>
			</div>
		</li>
		<li class="f3"><div class="tit"><img src="/common/front/images/facilities/3F_tit.png"></div><ul class="nav_sect"></ul><div class="in"><div class="bx_svg"><img src="/common/front/images/facilities/img_3f.png" alt=""><div class="bx_pin"></div></div></div></li>
	</ul>
</div>
<nav class="nav_floor">
	<ul>
