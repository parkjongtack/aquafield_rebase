								...
								<tr>
									...
									<td>
									    ...
									    <c:when test="${fn:length(memberInfo.MOBILE_NUM) > 10 }">
									    	<%-- <input type="text" value="${fn:substring(memberInfo.MOBILE_NUM,0,3)}">-
									    	<input type="text" value="${fn:substring(memberInfo.MOBILE_NUM,3,7)}">-
									    	<input type="text" value="${fn:substring(memberInfo.MOBILE_NUM,7,11)}"> --%>
									    	<input type="text" class="ipt w260" id="phoneNum" name="phoneNum" value="${memberInfo.MOBILE_NUM}" onblur="chkAccount.phone(this)">
									    </c:when>
									    <c:otherwise>
