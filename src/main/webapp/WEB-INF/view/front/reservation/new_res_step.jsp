...
document.cookie = "crossCookie=JSESSIONID; SameSite=None; Secure";
			...
			<div class="login_box box3" id="reserBox">
				<div class="form_type1-1" id="tab1-1" style="display:block;">
					...
					<ul class="res_info_list confirm">
			            ...
			            <c:if test="${pointInfo.CODE_ID eq 'POINT05'}">
				            <li class="type">
				                <div class="tit">지점</div>
				                <div class="info">
					                 <!-- <span class="pointNm">고양</span> -->
			            ...
			            <li class="type">
			                <div class="tit">고객이름<div style="margin-top:7px;">(SNS회원만 입력해주세요)</div></div>
			                <div class="info">
			                    <input type="text" id="member_name_empty" name="member_name_empty" style="width:200px;" <c:if test="${fn:indexOf(sessionScope.MEM_INFO.MEM_ID, 'naver_') == '-1' && fn:indexOf(sessionScope.MEM_INFO.MEM_ID, 'kakao_') == '-1'}"> value="${sessionScope.MEM_INFO.MEM_NM}" readOnly </c:if> />
			                </div>
			            </li>
			            <li class="type">
			        ...
			        <div class="item_list">
			        	<div id="resRule" class="resRule">
							...
							<ul>
				                ...
				                <li>본인을 포함하여 최대 4명까지 예약 가능합니다.</li>
...
<script type="text/javascript">
	...
	$("#btnGoPayment").unbind("click").bind("click", function(){
		...
		if($("#member_name_empty").val() == "") {
			alert("고객이름은 필수 입력 항목입니다.");
