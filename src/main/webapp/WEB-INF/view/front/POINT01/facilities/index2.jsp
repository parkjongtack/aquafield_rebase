					...
					<div class="content-inner">
						...
						<div id="floorMap">
							<section class="floorMenuArea">
								<ul>
									<li onclick="$(this).fadeHover(true);" class="n1"><button onclick="bxSlide.goToSlide(1);" data-num="1"><strong class="h">RF</strong><span class="img i-h"><img src="/images/facilities/btn_rnav1_off.png" alt=""></span></button></li>
									<li onclick="$(this).fadeHover(true);" class="n0"><button onclick="bxSlide.goToSlide(0);" data-num="0"><strong class="h">4F</strong><span class="img i-h"><img src="/images/facilities/btn_rnav2_off.png" alt=""></span></button></li>
									<li onclick="$(this).fadeHover(true);" class="n2"><button onclick="bxSlide.goToSlide(2);" data-num="2"><strong class="h">3F</strong><span class="img i-h"><img src="/images/facilities/btn_rnav3_off.png" alt=""></span></button></li>
								</ul>
							</section>
									...
									<div class="titArea">
										...
										<div class="list">
											...
											<div class="lst n5 f4" data-num="5"><button onclick="$mapId.zoomIn(true,4);">
												<span class="img i-h"><img src="/images/facilities/btn_u6_off.png" alt=""></span>
									...
									<div class="mapArea">
											...
											<div class="pos">
												<div class="box_map">
														<div class="box_marker">
															<img class="map" src="/images/facilities/map_4f.png"/>
															<div class="mk s0">
															<button class="mark before n0 n1_1" onclick="rLayerPopup('.n1_1');">
																<span class="img"><img src="/images/facilities/btn_more1_1.png"/></span>
															</button>
															<button class="mark before n1 n1_2" onclick="rLayerPopup('.n1_2');">
																<span class="img"><img src="/images/facilities/btn_more1_2.png"/></span>
															</button>
															<button class="mark before n2 n1_3" onclick="rLayerPopup('.n1_3');">
																<span class="img"><img src="/images/facilities/btn_more1_3.png"/></span>
															</button>
															<button class="mark before n3 n1_4" onclick="rLayerPopup('.n1_4');">
																<span class="img"><img src="/images/facilities/btn_more1_4.png"/></span>
															</button>
															<button class="mark before n7 n1_8" onclick="rLayerPopup('.n1_8');">
																<span class="img"><img src="/images/facilities/btn_more1_10.png"/></span>
															</button>
															<button class="mark before n5 n1_6" onclick="rLayerPopup('.n1_6');">
																<span class="img"><img src="/images/facilities/btn_more1_6.png"/></span>
															</button>
															<button class="mark before n4 n1_5" onclick="rLayerPopup('.n1_5');">
																<span class="img"><img src="/images/facilities/btn_more1_5.png"/></span>
															</button>
															<button class="mark before n6 n1_7" onclick="rLayerPopup('.n1_7');">
																<span class="img"><img src="/images/facilities/btn_more1_9.png"/></span>
															</button>
															<button class="mark before n8 n1_9" onclick="rLayerPopup('.n1_9');">
																<span class="img"><img src="/images/facilities/btn_more1_11.png"/></span>
															</button>
															<button class="mark before n9 n1_10" onclick="rLayerPopup('.n1_10');">
																<span class="img"><img src="/images/facilities/btn_more1_12.png"/></span>
															</button>
															<button class="mark before n10 n1_11" onclick="rLayerPopup('.n1_11');">
																<span class="img"><img src="/images/facilities/btn_more1_8.png"/></span>
															</button>
															<button class="mark before n11 n1_12" onclick="rLayerPopup('.n1_12');">
																<span class="img"><img src="/images/facilities/btn_more1_7.png"/></span>
															</button>
															</div>
															<div class="mk s1">
															<button class="mark before n12 n1_21" onclick="rLayerPopup('.n1_21');">
																<span class="img"><img src="/images/facilities/btn_more4_1.png"/></span>
															</button>
															<button class="mark before n13 n1_22" onclick="rLayerPopup('.n1_22');">
																<span class="img"><img src="/images/facilities/btn_more4_3.png"/></span>
															</button>
															<button class="mark before n13 n1_23" onclick="rLayerPopup('.n1_23');">
																<span class="img"><img src="/images/facilities/btn_more4_2.png"/></span>
															</button>
															</div>
															<div class="mk s2">
															<button class="mark before n16 n1_33" onclick="rLayerPopup('.n1_33');">
																<span class="img"><img src="/images/facilities/btn_more2_3.png"/></span>
															</button>
															<button class="mark before n15 n1_32" onclick="rLayerPopup('.n1_32');">
																<span class="img"><img src="/images/facilities/btn_more2_2.png"/></span>
															</button>
															<button class="mark before n14 n1_31" onclick="rLayerPopup('.n1_31');">
																<span class="img"><img src="/images/facilities/btn_more2_1.png"/></span>
															</button>
															<button class="mark before n17 n1_34" onclick="rLayerPopup('.n1_34');">
																<span class="img"><img src="/images/facilities/btn_more2_4.png"/></span>
															</button>
															<button class="mark before n18 n1_35" onclick="rLayerPopup('.n1_35');">
																<span class="img"><img src="/images/facilities/btn_more2_5.png"/></span>
															</button>
															<button class="mark before n19 n1_36" onclick="rLayerPopup('.n1_36');">
																<span class="img"><img src="/images/facilities/btn_more2_6.png"/></span>
															</button>
															</div>
															<div class="mk s3">
															<button class="mark before n20 n1_41" onclick="rLayerPopup('.n1_41');">
																<span class="img"><img src="/images/facilities/btn_more3_2.png"/></span>
															</button>
															<button class="mark before n21 n1_42" onclick="rLayerPopup('.n1_42');">
																<span class="img"><img src="/images/facilities/btn_more3_3.png"/></span>
															</button>
															<button class="mark before n22 n1_43" onclick="rLayerPopup('.n1_43');">
																<span class="img"><img src="/images/facilities/btn_more3_5.png"/></span>
															</button>
															<button class="mark before n28 n1_49" onclick="rLayerPopup('.n1_49');">
																<span class="img"><img src="/images/facilities/btn_more3_6.png"/></span>
															</button>
															<button class="mark before n23 n1_44" onclick="rLayerPopup('.n1_44');">
																<span class="img"><img src="/images/facilities/btn_more3_7.png"/></span>
															</button>
															<button class="mark before n24 n1_45" onclick="rLayerPopup('.n1_45');">
																<span class="img"><img src="/images/facilities/btn_more3_8.png"/></span>
															</button>
															<button class="mark before n25 n1_46" onclick="rLayerPopup('.n1_46');">
																<span class="img"><img src="/images/facilities/btn_more3_9.png"/></span>
															</button>
															<button class="mark before n26 n1_47" onclick="rLayerPopup('.n1_47');">
																<span class="img"><img src="/images/facilities/btn_more3_10.png"/></span>
															</button>
															<button class="mark before n27 n1_48" onclick="rLayerPopup('.n1_48');">
																<span class="img"><img src="/images/facilities/btn_more3_11.png"/></span>
															</button>
															
															<button class="mark before n29 n1_410" onclick="rLayerPopup('.n1_410');">
																<span class="img"><img src="/images/facilities/btn_more3_12.png"/></span>
															</button>
															<button class="mark before n30 n1_411" onclick="rLayerPopup('.n1_411');">
																<span class="img"><img src="/images/facilities/btn_more3_4.png"/></span>
															</button>
															<button class="mark before n31 n1_412" onclick="rLayerPopup('.n1_412');">
																<span class="img"><img src="/images/facilities/btn_more3_1.png"/></span>
															</button>
															</div>
															<div class="mk s4">
																<button class="mark before n32 n1_413" onclick="rLayerPopup('.n3_5');">
																	<span class="img"><img src="/images/facilities/btn_more6_4.png"/></span>
																</button>
															</div>
														</div>
														<img class="shadow" src="/images/facilities/map_4f_shadow.png"/>
										...
										<div class="lst n1"  data-num="1">
											<div class="pos">
												<div class="box_map">
														<div class="box_marker">
															<img class="map" src="/images/facilities/map_rf.png"/>
															<div class="mk s0">
																<button class="mark before n0 n2_1" onclick="rLayerPopup('.n2_1');"><img src="/images/facilities/btn_more5_1.png"/></button>
																<button class="mark before n1 n2_2" onclick="rLayerPopup('.n2_2');"><img src="/images/facilities/btn_more5_2.png"/></button>
																<button class="mark before n2 n2_3" onclick="rLayerPopup('.n2_3');"><img src="/images/facilities/btn_more5_3.png"/></button>
																<button class="mark before n4 n2_5" onclick="rLayerPopup('.n2_5');"><img src="/images/facilities/btn_more5_4.png"/></button>
																<button class="mark before n5 n2_6" onclick="rLayerPopup('.n2_6');"><img src="/images/facilities/btn_more5_5.png"/></button>
																<button class="mark before n6 n2_7" onclick="rLayerPopup('.n2_7');"><img src="/images/facilities/btn_more5_6.png"/></button>
																<button class="mark before n8 n2_9" onclick="rLayerPopup('.n2_7');"><img src="/images/facilities/btn_more5_6.png"/></button>
																<button class="mark before n7 n2_8" onclick="rLayerPopup('.n2_8');"><img src="/images/facilities/btn_more5_7.png"/></button>
															</div>
															<div class="mk s1">
																<button class="mark before n9 n2_10" onclick="rLayerPopup('.n2_4');"><img src="/images/facilities/btn_more5_8.png"/></button>
																<button class="mark before n3 n2_4" onclick="rLayerPopup('.n2_4');"><img src="/images/facilities/btn_more5_8.png"/></button>
															</div>
														</div>
														<img class="shadow" src="/images/facilities/map_rf_shadow.png"/>
												</div>
											</div>
										</div>
										...
										<div class="lst n2"  data-num="2">
											<div class="pos">
												<div class="box_map">
														<div class="box_marker">
															<img class="map" src="/images/facilities/map_3f.png"/>
															<button class="mark before n0 n3_1" onclick="rLayerPopup('.n3_1');"><img src="/images/facilities/btn_more6_1.png"/></button>
															<button class="mark before n2 n3_3" onclick="rLayerPopup('.n3_3');"><img src="/images/facilities/btn_more6_2.png"/></button>
															<button class="mark before n3 n3_4" onclick="rLayerPopup('.n3_4');"><img src="/images/facilities/btn_more6_3.png"/></button>
														</div>
														<img class="shadow" src="/images/facilities/map_3f_shadow.png"/>
												</div>
											</div>
										</div>
