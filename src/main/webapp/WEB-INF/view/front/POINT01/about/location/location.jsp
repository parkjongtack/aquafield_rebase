...
<%@ include file="../../../../common/taglibs.jsp" %>
    <section id="location">
				                        ...
				                        <dl>
				                        	...
				                        	<dd class="traffic">
				                        		<table class="traffic1">
				                        			<tbody>
					                                    <tr>
					                                        <th class="local">성남방면 : </th>
					                                        <td>
						                                        <span>성남대로</span>
																<span class="arrow"><img src="/common/front/images/ico/ico_location_arr.png" alt="" /></span>
																<span>서울외곽순환고속도로</span>
																<span class="arrow"><img src="/common/front/images/ico/ico_location_arr.png" alt="" /></span>
																<span>중부고속도로</span>
																<span class="arrow"><img src="/common/front/images/ico/ico_location_arr.png" alt="" /></span>
																<span>하남IC</span>
        ...
        <div id="addressBx">
			<div class="inner">
				<ul>
    				<li>주   소   :  경기도 하남시 미사대로 750 (스타필드 하남 3F)</li>
    				<li>연락처   :  031-8072-8800</li>
    			</ul>
			</div>
		</div>
        ...
        <script type="text/javascript">
		    ...
		    function drawMap(){
				var mapContainer = document.getElementById('map'), // 지도를 표시할 div
				    mapOption = {
				        center: new daum.maps.LatLng(37.5454502, 127.2239212), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
		    ...
		    function aquaMarkers(map){
				...
				markerPosition = new daum.maps.LatLng(37.5454502, 127.2239212); // 마커가 표시될 위치입니다
