                        ...
                        <div class="col s6">
                            ...
                            <div class="side_box side_box1">
	                            <div class="inner">
	                            	...
	                            	<ul class="cnt">
										<li>-7/1~7/14</li>
	                            		<li>&nbsp09:00 ~ 19:00(실내/실외)</li>
										<li>-7/15~8/20</li>
	                            		<li>&nbsp09:00 ~ 21:00(실내/실외)</li>
										<li>-8/21~별도 공지 시 까지</li>
										<li>&nbsp10:00~19:00(실내)</li>
										<li>&nbsp11:00~18:00(실외)</li>
	                            	</ul>
	                            </div>
                            </div>
                        </div>
                        ...
                        <table class="pc">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="2">워터파크</th>
                                </tr>
                                <tr>
                                    <th>주중</th>
                                    <th>주말/공휴일</th>
                                    <th>평수기<br/>(성수기 제외 기간)</th>
                                    <th>성수기<br/>(7/15 ~ 8/20)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
