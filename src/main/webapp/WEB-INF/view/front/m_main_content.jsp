	...
	<c:choose>
        	...
        	<ul>
				<li>
					<a href="#/about/concept/index.af">
						<img src="/common/front/images/POINT05/main/m_ico_01.png" alt="소개">
						<p>소개</p>
					</a>
				</li>
				<li>
					<a href="#/facilities/index.af?depth1=2">
						<img src="/common/front/images/POINT05/main/m_ico_02.png" alt="시설안내">
						<p>시설안내</p>
					</a>
				</li>
				<li>
					<a href="#/guide/index.af?page=1">
						<img src="/common/front/images/POINT05/main/m_ico_03.png" alt="이용안내">
						<p>이용안내</p>
					</a>
				</li>
				<li>
					<a href="#/event/eventIndex.af?cate=0">
						<img src="/common/front/images/POINT05/main/m_ico_04.png" alt="이벤트 · 소식">
						<p>이벤트 · 소식</p>
					</a>
				</li>
			</ul>
		...
		<c:otherwise>
			<ul>
				<li>
					<a href="#/about/concept/index.af">
						<img src="/common/front/images/main/m_ico_01.png" alt="소개">
						<p>소개</p>
					</a>
				</li>
				<li>
					<a href="#/facilities/index.af?depth1=2">
						<img src="/common/front/images/main/m_ico_02.png" alt="시설안내">
						<p>시설안내</p>
					</a>
				</li>
				<li>
					<a href="#/guide/index.af?page=1">
						<img src="/common/front/images/main/m_ico_03.png" alt="이용안내">
						<p>이용안내</p>
					</a>
				</li>
				<li>
					<a href="#/event/eventIndex.af?cate=0">
						<img src="/common/front/images/main/m_ico_05.png" alt="이벤트 · 소식">
						<p>이벤트 · 소식</p>
					</a>
				</li>
			</ul>
