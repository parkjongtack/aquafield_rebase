                        ...
                        <table>
                            <tbody>
                                    ...
                                    <td colspan="3">
                                        <div class="select st2">
                                            <select name="kind" id="writeType" class="customized-select w150">
                                                <option value="1"<c:if test="${result.KIND eq '1'}"> selected</c:if>>공지사항</option>
                                                <option value="2"<c:if test="${result.KIND eq '2'}"> selected</c:if>>이벤트</option>
                                            </select>
                                        </div>
                                        <input type="checkbox" name="openYn" id="openYn" value="N"<c:if test="${result.OPEN_YN eq 'N'}"> selected</c:if>> 비공개
                                    </td>
                                </tr>
                                <tr class="eventOption">
                                    ...
                                    <td>
                                        <div class="placeh">
                                            <input type="text" class="ipt w100 datepicker" name="startDate" id="startDate" value="${result.START_DATE}" onblur="chkAccount.birthday(this)">
                                            <span> - </span>
                                            <input type="text" class="ipt w100 datepicker" name="endDate" id="endDate" value="${result.END_DATE}" onblur="chkAccount.birthday(this)">
                                        </div>
                                    </td>
                                    <th>장소</th>
                                    <td>
                                        <input type="text" class="ipt w100p" name="location" id="location" onblur="" value="${result.LOCATION}" maxlength="200">
                                    </td>
                                </tr>
                                <tr class="require">
                                    <th>제목<span>*</span></th>
                                    <td colspan="3">
                                        <input type="text" class="ipt w100p" name="title" onblur="" value="${result.TITLE}" maxlength="200">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="lst_Upload">
                                            <span class="tag" id="span-banner_1">${result.FILE_LIST}<!-- <button onclick="deleteAttach('10', 'banner', '1');" alt="삭제하기" title="삭제하기">삭제</button> --></span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="lst_Upload">
                                            <span class="tag" id="span-banner_1">${result.FILE_CONTENT}<!-- <button onclick="deleteAttach('10', 'banner', '1');" alt="삭제하기" title="삭제하기">삭제</button> --></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <ul class="inputOption">
                                            <li><input type="checkbox" name="page1" value="Y"<c:if test="${result.PAGE1_YN eq 'Y'}"> checked</c:if>> 1Page</li>
                                            <li>
                                                - Left
                                                <div class="select st2">
                                                    <select name="page1LeftKind" id="page1LeftKind" class="customized-select w150 select_left">
                                                        <option value="text"<c:if test="${result.PAGE1_LEFT_KIND eq 'text'}"> selected</c:if>>Text</option>
                                                        <option value="image"<c:if test="${result.PAGE1_LEFT_KIND eq 'image'}"> selected</c:if>>image</option>
                                                    </select>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="select st2">
                                                    <select name="page1RightKind" id="page1RightKind" class="customized-select w150 select_right">
                                                        <option value="text"<c:if test="${result.PAGE1_RIGHT_KIND eq 'text'}"> selected</c:if>>Text</option>
                                                        <option value="image"<c:if test="${result.PAGE1_RIGHT_KIND eq 'image'}"> selected</c:if>>image</option>
                                                    </select>
                                                </div>
                                            </li>
                                        </ul>
                                        <ul class="inputOption">
                                            <li><input type="checkbox" name="page2" value="Y"<c:if test="${result.PAGE2_YN eq 'Y'}"> checked</c:if>> 2Page</li>
                                            <li>
                                                - Left
                                                <div class="select st2">
                                                    <select name="page2LeftKind" id="page2LeftKind" class="customized-select w150 select_left">
                                                        <option value="text"<c:if test="${result.PAGE2_LEFT_KIND eq 'text'}"> selected</c:if>>Text</option>
                                                        <option value="image"<c:if test="${result.PAGE2_LEFT_KIND eq 'image'}"> selected</c:if>>image</option>
                                                    </select>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="select st2">
                                                    <select name="page2RightKind" id="page2RightKind" class="customized-select w150 select_right">
                                                        <option value="text"<c:if test="${result.PAGE2_RIGHT_KIND eq 'text'}"> selected</c:if>>Text</option>
                                                        <option value="image"<c:if test="${result.PAGE2_RIGHT_KIND eq 'image'}"> selected</c:if>>image</option>
                                                    </select>
                                                </div>
                                            </li>
                                        </ul>
                                        <ul class="inputOption">
                                            <li><input type="checkbox" name="page3" value="Y"<c:if test="${result.PAGE3_YN eq 'Y'}"> checked</c:if>> 3Page</li>
                                            <li>
                                                - Left
                                                <div class="select st2">
                                                    <select name="page3LeftKind" id="page3LeftKind" class="customized-select w150 select_left">
                                                        <option value="text"<c:if test="${result.PAGE3_LEFT_KIND eq 'text'}"> selected</c:if>>Text</option>
                                                        <option value="image"<c:if test="${result.PAGE3_LEFT_KIND eq 'image'}"> selected</c:if>>image</option>
                                                    </select>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="select st2">
                                                    <select name="page3RightKind" id="page3RightKind" class="customized-select w150 select_right">
                                                         <option value="text"<c:if test="${result.PAGE3_RIGHT_KIND eq 'text'}"> selected</c:if>>Text</option>
                                                        <option value="image"<c:if test="${result.PAGE3_RIGHT_KIND eq 'image'}"> selected</c:if>>image</option>
                                                    </select>
                                                </div>
                                            </li>
                                        </ul>
...
<c:choose>
	<c:when test="${result.PAGE1_YN eq 'Y'}">
                                <tr class="page1">
                                    <td>1Page</td>
                                    <td class="left">
	<c:choose>
		<c:when test="${result.PAGE1_LEFT_KIND eq 'text'}">
                                        <div class="textArea">
                                            <textarea name="page1LeftContent" id="page1LeftContent" rows="10">${result.PAGE1_LEFT_CONTENT}</textarea>
                                        </div>
		</c:when>
		<c:otherwise>
                                        <div class="fileArea">
                                            <div class="fileinputs" data-text="파일첨부">
                                                <input type="file" class="file" name="page1LeftImg" id="page1LeftImg">
                                            </div>
                                            <div class="lst_Upload">
	                                            <span class="tag" id="span-banner_1">${result.PAGE1_LEFT_IMG}</span>
	                                        </div>
                                        </div>
		</c:otherwise>
	</c:choose>
	...
	<c:choose>
		<c:when test="${result.PAGE1_RIGHT_KIND eq 'text'}">
                                        <div class="textArea">
                                            <textarea name="page1RightContent" id="page1RightContent" rows="10">${result.PAGE1_RIGHT_CONTENT}</textarea>
                                        </div>
		</c:when>
		<c:otherwise>
                                        <div class="fileArea">
                                            ...
                                            <div class="lst_Upload">
	                                            <span class="tag" id="span-banner_1">${result.PAGE1_RIGHT_IMG}</span>
	                                        </div>
                                        </div>
		</c:otherwise>
	</c:choose>
...
<c:choose>
	<c:when test="${result.PAGE2_YN eq 'Y'}">
                                <tr class="page2">
                                    <td>2Page</td>
                                    <td class="left">
	<c:choose>
		<c:when test="${result.PAGE2_LEFT_KIND eq 'text'}">
                                        <div class="textArea">
                                            <textarea name="page2LeftContent" id="page2LeftContent" rows="10">${result.PAGE2_LEFT_CONTENT}</textarea>
                                        </div>
		</c:when>
		<c:otherwise>
                                        <div class="fileArea">
                                            <div class="fileinputs" data-text="파일첨부">
                                                <input type="file" class="file" name="page2LeftImg" id="page2LeftImg">
                                            </div>
                                            <div class="lst_Upload">
	                                            <span class="tag" id="span-banner_1">${result.PAGE2_LEFT_IMG}</span>
	                                        </div>
                                        </div>
		</c:otherwise>
	</c:choose>
                                    ...
                                    <td class="right" colspan="2">
	<c:choose>
		<c:when test="${result.PAGE2_RIGHT_KIND eq 'text'}">
                                        <div class="textArea">
                                            <textarea name="page2RightContent" id="page2RightContent" rows="10">${result.PAGE2_RIGHT_CONTENT}</textarea>
                                        </div>
		</c:when>
		<c:otherwise>
                                        <div class="fileArea">
                                            ...
                                            <div class="lst_Upload">
	                                            <span class="tag" id="span-banner_1">${result.PAGE2_RIGHT_IMG}</span>
	                                        </div>
                                        </div>
		</c:otherwise>
	</c:choose>
...
<c:choose>
	<c:when test="${result.PAGE3_YN eq 'Y'}">
                                <tr class="page3">
                                    <td>3Page</td>
                                    <td class="left">
	<c:choose>
		<c:when test="${result.PAGE3_LEFT_KIND eq 'text'}">
                                        <div class="textArea">
                                            <textarea name="page3LeftContent" id="page3LeftContent" rows="10">${result.PAGE3_LEFT_CONTENT}</textarea>
                                        </div>
		</c:when>
		<c:otherwise>
                                        <div class="fileArea">
                                            <div class="fileinputs" data-text="파일첨부">
                                                <input type="file" class="file" name="page3LeftImg" id="page3LeftImg">
                                            </div>
                                            <div class="lst_Upload">
	                                            <span class="tag" id="span-banner_1">${result.PAGE3_LEFT_IMG}</span>
	                                        </div>
                                        </div>
		</c:otherwise>
	</c:choose>
                                    ...
                                    <td class="right" colspan="2">
	<c:choose>
		<c:when test="${result.PAGE3_RIGHT_KIND eq 'text'}">
                                        <div class="textArea">
                                            <textarea name="page3RightContent" id="page3RightContent" rows="10">${result.PAGE3_RIGHT_CONTENT}</textarea>
                                        </div>
		</c:when>
		<c:otherwise>
                                        <div class="fileArea">
                                            ...
                                            <div class="lst_Upload">
	                                            <span class="tag" id="span-banner_1">${result.PAGE3_RIGHT_IMG}</span>
	                                        </div>
                                        </div>
		</c:otherwise>
	</c:choose>
	...
	<c:otherwise>
        ...
        <c:if test="${result.PAGE1_YN eq 'Y'}">
        <script>
        $('.page1').addClass('active');
        </script>
        </c:if>
        <c:if test="${result.PAGE2_YN eq 'Y'}">
        <script>
        $('.page2').addClass('active');
        </script>
        </c:if>
        <c:if test="${result.PAGE3_YN eq 'Y'}">
        <script>
